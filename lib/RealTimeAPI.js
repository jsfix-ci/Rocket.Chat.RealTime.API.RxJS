...
var RealTimeAPI = /** @class */ (function () {
    function RealTimeAPI(param) {
        this.webSocket = (0, webSocket_1.webSocket)(param);
    }
    /**
    ...
    RealTimeAPI.prototype.getObservableFilteredByMessageType = function (messageType) {
        return this.getObservable().pipe((0, operators_1.filter)(function (message) { return message.msg === messageType; }));
    };
    /**
     * getObservableFilteredByID
     */
    RealTimeAPI.prototype.getObservableFilteredByID = function (id) {
        return this.getObservable().pipe((0, operators_1.filter)(function (message) { return message.id === id; }));
    };
    /**
     * connectToServer
     */
    ...
    RealTimeAPI.prototype.keepAlive = function () {
        var _this = this;
        return this.getObservableFilteredByMessageType("ping").pipe((0, operators_1.tap)(function () { return _this.sendMessage({ msg: "pong" }); }));
    };
    /**
            ...
            params: [
                {
                    ...
                    password: {
                        digest: (0, crypto_js_1.SHA256)(password).toString(),
                        algorithm: "sha-256"
                    }
                }
            ]
    ...
    RealTimeAPI.prototype.getLoginObservable = function (id) {
        ...
        var resultId;
        var addedObservable = this.getObservable().pipe((0, operators_1.buffer)(resultObservable.pipe((0, operators_1.map)(function (_a) {
            var msg = _a.msg, error = _a.error, result = _a.result;
            if (msg === "result" && !error)
                return (resultId = result.id); // Setting resultId to get Result from the buffer
        }))), (0, operators_1.flatMap)(function (x) { return x; }), // Flattening the Buffered Messages
        (0, operators_1.filter)(function (_a) {
            var msgId = _a.id;
            return resultId !== undefined && msgId === resultId;
        }), //Filtering the "added" result message.
        (0, operators_1.merge)(resultObservable) //Merging "result" and "added" messages.
        );
    ...
    RealTimeAPI.prototype.getSubscription = function (streamName, streamParam, addEvent) {
        var id = (0, uuid_1.v4)();
        return this.webSocket.multiplex(function () { return ({
            msg: "sub",
            id: id,
            name: streamName,
